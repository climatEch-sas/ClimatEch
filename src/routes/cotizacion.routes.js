...
import { getAll, getOne, create, updateEstado, remove, generatePDF, getSolicitudesCliente } from '../controllers/cotizacion.controller.js';
import { authenticate, authorize } from '../middlewares/auth.middleware.js';

const router = Router();
router.use(authenticate);
router.get('/', authorize('ADMIN', 'CLIENTE'), getAll);
router.get('/solicitudes/:clienteId', authorize('ADMIN'), getSolicitudesCliente);
